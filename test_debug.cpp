...
int main() {
  ...
  std::cout << "  After get(), result=" << result << ", done=" << task1.done()
            << std::endl;
  ...
  std::cout << "  After creating task2, executed=" << executed
            << ", done=" << task2.done() << std::endl;
  task2.get();
  std::cout << "  After get(), executed=" << executed
            << ", done=" << task2.done() << std::endl;
